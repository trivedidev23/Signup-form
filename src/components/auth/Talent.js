...
import { registerTalent } from "../../actions/auth";

const Talent = ({ registerTalent }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = (e) => {
    registerTalent({ Firstname, Lastname, Username, Email, Password });
    alert("Successfully, Signed Up for your Talent account.");
  };
          ...
          <div className="login_form">
            <ul className="nav nav-pills">
              <li className="nav-item d-flex justify-content-center">
                ...
                <NavLink className="nav-link active" to="/talent">
                  TALENT SIGNUP
                </NavLink>
              </li>
            </ul>
            <div className="account">
              <h2>Create Your Talent Account</h2>
            </div>
...
export default connect(null, { registerTalent })(Talent);
